    ...
    <section className="w-full max-w-3xl mx-auto">
      ...
      <div className="space-y-3">
        {questions.map((faq, i) => (
          ...
          >
            <summary className="flex cursor-pointer list-none items-center justify-between px-5 py-4 font-medium text-gray-800 dark:text-[#e2e8f0] hover:text-[#1e3a5f] dark:hover:text-blue-400 transition">
              {faq.q}
