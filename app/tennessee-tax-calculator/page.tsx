...
export const metadata: Metadata = {
  title: 'Tennessee Income Tax Calculator 2026',
  description: 'Calculate your Tennessee state income tax for 2026. Free TN tax calculator with No earned income tax and combined federal + state income tax estimate.',
  alternates: { canonical: 'https://taxcalculators.app/tennessee-tax-calculator' },
  robots: { index: true, follow: true },
}

const faqs: FaqItem[] = [
  {
    q: 'What is the Tennessee income tax rate for 2026?',
    a: 'Tennessee has no state income tax in 2026 — residents pay zero state income tax on wages, salary, and most investment income. Tennessee has no tax on earned income. Tennessee fully eliminated its Hall Tax on interest and dividends in 2022. Tennessee\'s 7% state sales tax (among the highest nationally) compensates for the lack of income tax. Tennessee is popular with retirees from high-tax states.',
  },
  {
    q: 'Does Tennessee have a standard deduction?',
    a: 'Tennessee does not have a state income tax standard deduction since there is no state income tax system. The federal standard deduction ($15,750 single, $31,500 MFJ in 2026) still applies to your federal return filed with the IRS.',
  },
  {
    q: 'What taxes do Tennessee residents pay instead of income tax?',
    a: 'Tennessee has no tax on earned income. Tennessee fully eliminated its Hall Tax on interest and dividends in 2022. Tennessee\'s 7% state sales tax (among the highest nationally) compensates for the lack of income tax. Tennessee is popular with retirees from high-tax states. State and local government funding in Tennessee comes from other sources including sales taxes, property taxes, excise taxes, and in some cases natural resource revenues. Understanding your total tax burden including these taxes gives a complete picture.',
  },
  {
    q: 'Is Tennessee a good state for high earners from a tax perspective?',
    a: 'Yes — with no state income tax, Tennessee is very favorable for high earners. A person earning $200,000 saves $8,000-$20,000 per year in state income taxes compared to living in a state with a 4-10% income tax. This makes Tennessee attractive for executives, business owners, high-income professionals, and retirees relocating from high-tax states.',
  },
  {
    q: 'How do I calculate my combined federal and Tennessee state income tax?',
    a: 'Use the calculator above. Enter your income and TN is pre-selected as your state. The calculator computes your 2026 federal income tax using the One Big Beautiful Bill Act brackets (10%-37%), adds your estimated Tennessee state income tax (No earned income tax simplified), and displays your total tax burden, combined effective rate, and annual take-home pay. All calculations happen instantly in your browser.',
  },
]
...
const webAppSchema = {
  '@context': 'https://schema.org',
  '@type': 'WebApplication',
  name: 'Tennessee Income Tax Calculator 2026',
  url: 'https://taxcalculators.app/tennessee-tax-calculator',
...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How to Calculate Tennessee State Income Tax',
  step: [
    { '@type': 'HowToStep', name: 'Enter your income and filing status', text: 'Tennessee is pre-selected as your state. Enter your annual income and select your federal filing status (Single, Married Jointly, Head of Household).' },
    { '@type': 'HowToStep', name: 'View your Tennessee state tax estimate', text: 'See your estimated Tennessee state income tax (No earned income tax), your federal income tax under 2026 OBBBA brackets, and your combined effective tax rate.' },
    { '@type': 'HowToStep', name: 'Compare with other states', text: 'The calculator shows how your Tennessee tax compares to no-income-tax states and the national average, helping you understand your total tax burden.' },
  ],
}

const trustSignals = ['📋 2026 Updated', '⚡ Instant', '🔒 Private', '✓ Free']

export default function TennesseeTaxCalculatorPage() {
  return (
    <>
        ...
        <div className="relative z-10 pb-10">
          ...
          <div className="text-center text-white px-4 py-8">
            ...
            <p className="text-lg sm:text-xl text-white/80 mb-6 max-w-2xl mx-auto">
              Estimate your Tennessee state income tax plus combined federal and TN state tax for 2026. No earned income tax.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-4">
            <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-2xl rounded-2xl overflow-hidden">
              <StateTaxCalculatorWrapper defaultState="TN" />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="rounded-2xl bg-blue-50 dark:bg-blue-950/30 border border-blue-100 dark:border-blue-900/50 px-6 py-5 mb-10">
            ...
            <p className="text-sm text-blue-800 dark:text-blue-400 leading-relaxed">
              Tennessee has no tax on earned income. Tennessee fully eliminated its Hall Tax on interest and dividends in 2022. Tennessee's 7% state sales tax (among the highest nationally) compensates for the lack of income tax. Tennessee is popular with retirees from high-tax states. Use the calculator above to estimate your combined federal and Tennessee state income tax for 2026. State tax figures use a simplified rate — for precise Tennessee state tax calculations, consult the Tennessee Department of Revenue or a licensed tax professional.
            </p>
          </div>
