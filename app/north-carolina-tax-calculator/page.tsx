...
const howToSchema = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'How to Calculate North Carolina State Income Tax',
  step: [
    { '@type': 'HowToStep', name: 'Enter your income and filing status', text: 'North Carolina is pre-selected as your state. Enter your annual income and select your federal filing status (Single, Married Jointly, Head of Household).' },
    { '@type': 'HowToStep', name: 'View your North Carolina state tax estimate', text: 'See your estimated North Carolina state income tax (4.25% flat rate), your federal income tax under 2026 OBBBA brackets, and your combined effective tax rate.' },
    { '@type': 'HowToStep', name: 'Compare with other states', text: 'The calculator shows how your North Carolina tax compares to no-income-tax states and the national average, helping you understand your total tax burden.' },
  ],
}
    ...
    <>
      ...
      <section className="bg-white dark:bg-[#0f172a] pt-6">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">How North Carolina State Income Tax Works</h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              North Carolina uses a 4.25% flat rate state income tax structure. Like most states, North Carolina starts its calculation from your federal Adjusted Gross Income (AGI), then applies state-specific adjustments — subtracting income North Carolina excludes from taxation (such as certain pension or Social Security income) and adding back any income North Carolina taxes that the federal government does not. After adjustments, the North Carolina standard deduction is applied, then the 4.25% flat rate is applied to arrive at state taxable income.
            </p>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              North Carolina income tax is collected through employer paycheck withholding for W-2 employees and through quarterly estimated payments for self-employed residents and those with significant non-wage income. The North Carolina state return is generally due April 15, aligned with federal returns. Part-year residents and nonresidents who earn income sourced in North Carolina must also file a North Carolina return for that income portion.
            </p>
            <div className="bg-gray-100 dark:bg-gray-800 rounded-xl px-4 py-3 mb-4 text-sm font-mono text-gray-800 dark:text-gray-200">
              State Tax = (North Carolina taxable income) x 4.25% flat rate - State credits
            </div>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Your North Carolina state income taxes are deductible on your federal Schedule A as part of the SALT (State and Local Tax) deduction, capped at $40,400 in 2026 under OBBBA. At the 22% federal bracket, paying $2,518 in North Carolina state income tax generates approximately $553 in federal tax savings, reducing the true net cost of your North Carolina taxes to about $1,965 for itemizing taxpayers.
            </p>
          </div>

          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Worked Example: $75,000 Income in North Carolina</h2>
            <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/40 rounded-2xl p-6">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Jordan is a single filer earning $75,000 in North Carolina. This shows how federal and North Carolina state income tax are calculated together.
              </p>
              <div className="space-y-1 text-sm text-gray-700 dark:text-gray-300 mb-4 font-mono bg-white/60 dark:bg-black/20 rounded-xl px-4 py-3">
                ...
                <div>North Carolina state tax (at 4.25% flat rate):  $2,518</div>
                <div className="font-bold pt-1">Total (federal + North Carolina state):        $10,467</div>
          ...
          <div className="mb-10">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Key Factors That Affect Your North Carolina Tax</h2>
            <ul className="space-y-5">
              <li>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">North Carolina Tax Rate and Annual Filing</p>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">North Carolina residents earning above the state filing threshold must file a North Carolina income tax return annually, typically due April 15. The 4.25% flat rate applies after North Carolina-specific deductions and any state tax credits. Employers withhold North Carolina state income tax from employee paychecks throughout the year using North Carolina withholding tables, and any balance owed or refund due is settled when the annual state return is filed. Self-employed North Carolina residents make quarterly estimated payments to the state in addition to their federal quarterly estimated tax payments.</p>
              </li>
              <li>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">Federal SALT Deduction Reduces Net State Tax Cost</p>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">State income taxes paid in North Carolina reduce your federal taxable income through the SALT deduction (capped at $40,400 in 2026 under OBBBA). For a North Carolina resident in the 22% federal bracket paying $2,518 in state income tax, the SALT deduction recovers approximately $553 in federal taxes, so the true after-federal-benefit cost of North Carolina state income tax is about $1,965. This offset only benefits taxpayers who itemize deductions on federal Schedule A rather than taking the standard deduction.</p>
              </li>
              <li>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">Total Tax Burden: State Income Tax Is One Piece</p>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">State income tax is one component of your total tax burden in North Carolina. Property taxes, local income taxes (in some North Carolina cities and counties), and state and local sales taxes also contribute to your overall cost of living. When comparing North Carolina to other states, evaluate all tax types together rather than income tax in isolation. Use the calculator above to see your combined federal and North Carolina state effective rate at your specific income level.</p>
              </li>
            </ul>
          </div>
